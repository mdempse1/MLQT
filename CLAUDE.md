...
| `Design/design-phase7-gui-tests.md` | Phase 7a — the code-behind sweep, the test harness it enables, and the `/selftest` baseline that must precede the desktop-host migration; §7b sketches the migration |
