...
public class OneOfEachSection : VisitorWithModelNameTracking
{
    ...
    private void CheckPublicSection(modelicaParser.CompositionContext context, SectionTracker tracker)
    {
        ...
        {
            AddFinding(context.Start.Line, "This class contains more than 1 public section", RuleIds.OneOfEachSection);
        }
    }
    ...
    private void CheckProtectedSection(modelicaParser.CompositionContext context, SectionTracker tracker)
    {
        ...
        {
            AddFinding(context.Start.Line, "This class contains more than 1 protected section", RuleIds.OneOfEachSection);
        }
    }
    ...
    private void CheckEquationSection(modelicaParser.CompositionContext context, SectionTracker tracker, bool isInitial)
    {
        if (isInitial)
        {
            ...
            {
                AddFinding(context.Start.Line, "This class contains more than 1 initial equation section", RuleIds.OneOfEachSection);
            }
            if (tracker.InitialAlgorithmSection == 1 && !_allowEquationAndAlgorithm)
            {
                AddFinding(context.Start.Line, "This class contains both an initial algorithm and an initial equation section", RuleIds.DontMixEquationAndAlgorithm);
            }
        ...
        else
        {
            ...
            {
                AddFinding(context.Start.Line, "This class contains more than 1 equation section", RuleIds.OneOfEachSection);
            }
            if (tracker.AlgorithmSection == 1 && !_allowEquationAndAlgorithm)
            {
                AddFinding(context.Start.Line, "This class contains both an algorithm and an equation section", RuleIds.DontMixEquationAndAlgorithm);
            }
    ...
    private void CheckAlgorithmSection(modelicaParser.CompositionContext context, SectionTracker tracker, bool isInitial)
    {
        if (isInitial)
        {
            ...
            {
                AddFinding(context.Start.Line, "This class contains more than 1 initial algorithm section", RuleIds.OneOfEachSection);
            }
        ...
        else
        {
            ...
            {
                AddFinding(context.Start.Line, "This class contains more than 1 algorithm section", RuleIds.OneOfEachSection);
            }
