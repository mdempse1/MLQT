...
into work packages by shared root cause rather than by area (WP0–WP12; WP0, WP1, WP2, WP3, WP4, WP8 and WP11 are done), and records the eleven root causes established while planning — two of which change what the
fix is.
